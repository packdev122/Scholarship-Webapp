	...
	<div class="page-sidebar-wrapper">
		<div class="page-sidebar navbar-collapse collapse">
			...
			<ul class="page-sidebar-menu page-sidebar-menu-hover-submenu" data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200">
				...
				<li class="start <?php if( Route::currentRouteName() == "admin/settings" )echo 'active open';?>">
					<a href="#">
				...
				@endif
				<li class="<?php if( Route::currentRouteName() == "admin/applications" )echo 'active open';?>">
					<a href="{{ url('/admin/applications') }}">
					<i class="icon-list"></i>
			 	...
			 	<li class="<?php if( Route::currentRouteName() == "admin/scores" )echo 'active open';?>">
				...
				@if(Auth::user()->isSuperAdmin())
				<li class="<?php if( substr_count( Route::currentRouteName(),"admin/email_templates")>0 )echo 'active open';?>">
					<a href="{{ url('/admin/email_templates/0') }}">
