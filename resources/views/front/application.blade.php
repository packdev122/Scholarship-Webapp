    ...
    <div class='page-content pt-100 pb-100'>
        <div class='row mt-20'>
            <div class='col-lg-3 border-right-white'>
                <h1 class='text-uppercase'>Application</h1>
            </div>
            <div class='col-lg-9'>
                <div class="d-flex justify-content-center">
                    <div class="" style='width:100%'>
                        ...
                        <form method="POST" action="{{ url('application') }}" enctype="multipart/form-data" id='application_form'>
                            @csrf
                            <input type='checkbox'>&nbsp;<label>I've read and accept the terms and conditions</label>
                            <p class='font-size-16 font-bold text-uppercase text-black'>
                                Your information
                            </p><hr class='hr1'>
                            <div class='row form-group'>
                                <div class='col-lg-6'>
                                    ...
                                    <input type='text' class='form-control' name='application[first_name]' value="{{ $application['first_name']?$application['first_name']:''}}">
                                </div>
                                <div class='col-lg-6'>
                                    <label class='control-label' >Last name*</label>
                                    <input type='text' class='form-control' name='application[last_name]' value="{{ $application['last_name']?$application['last_name']:'' }}">
                                </div>
                            </div>
                            <div class='form-group'>
                                <label class='control-label' >Middle name</label>
                                <input type='text' class='form-control' name='application[middle_name]' value="{{ $application['middle_name']?$application['middle_name']:'' }}">
                            </div>
                            <div class='form-group'>
                                <label class='control-label'>MIT ID*</label>
                                <input type='text' class='form-control' name='application[mit_id]' value="{{$application['mit_id']?$application['mit_id']:'' }}">
                            </div>
                            <div class='form-group'>
                            ...
                            <div class='form-group'>
                                ...
                                <div class='row'>
                                    <div class='col-md-2 col-lg-2'>
                                        <input type='text' class='form-control' value="{{ $application['phone1']?$application['phone1']:'' }}"" name='application[phone1]' required>
                                    </div>
                                    <div class='col-md-10 col-lg-10'>
                                        <input type='text' class='form-control' value="{{ $application['phone2']?$application['phone2']:'' }}" name='application[phone2]' required>
                                    </div>
                                </div>
                            </div>
                            <p class='font-bold'>Birthday*</p>
                            <div class='form-group'>
                                <input class="form-control datepicker" data-date-format="yyyy-mm-dd" name='application[birthday]' value="{{ $application['birthday']?$application['birthday']:'' }}">
                            </div>
                            <div class='form-group' style='border:1px solid #ccc;padding:10px'>
                                <label class='control-label'>Team Memebers</label>
                                <div style='width:100%;overflow:auto'>
                                    <table class='table table-bordered table striped applicant-table'>
                                        <thead>
                                            <th>Full Name</th>
                                            <th>Email Id</th>
                                        ...
                                        <tfoot>
                                            <tr>
                                                <th><input class="form-control" id='member_first_name' value=""></th>
                                                <th><input class="form-control" id='member_email' value=""></th>
                                                <th>
                                                ...
                                                <th class=''>
                                                    <a class='' id='add_member'><i class='fa fa-plus'></i></a>
                                                </th>
                                            </tr>
                                        </tfoot>
                                    </table>
                            ...
                            <div class='form-group'>
                                ...
                                <input type='text' class='form-control' name='application[email]' value="{{ $application['email']?$application['email']:'' }}">
                            </div>
                            <div class='form-group'>
                                <label class='control-label'>Permanent Address*</label>
                                <input type='text' class='form-control' name='application[address1]' value="{{ isset($application['address1']) ? $application['address1'] : '' }}">
                                <label class='control-label'  >Address1</label>
                            </div>
                            <div class='form-group'>
                                <input type='text' class='form-control' name='application[address2]' value="{{ isset($application['address2']) ? $application['address2'] : '' }}">
                                <label class='control-label' >Address2</label>
                            </div>
                            <div class='row form-group'>
                                <div class='col-lg-8'>
                                    <input type='text' class='form-control' name='application[city]' value="{{ isset($application['city']) ? $application['city'] : '' }}">
                                    <label class='control-label'>City*</label>
                                </div>
                                <div class='col-lg-4'>
                                    <input type='text' class='form-control' name='application[province]' value="{{ isset($application['province']) ? $application['province'] : '' }}">
                                    <label class='control-label'>State/Province*</label>
                                </div>
                            </div>
                            <div class='row form-group'>
                                <div class='col-lg-4'>
                                    <input type='text' class='form-control' name='application[postal_code]' value="{{ isset($application['postal_code']) ? $application['postal_code'] : '' }}">
                            ...
                            <div class='form-group'>
                                ...
                                <textarea class='form-control' style='height:100px' name='question[1]'>{{ $questions[1] ? $questions[1]->answer : '' }}</textarea>
                            ...
                            <div class='form-group'>
                                ...
                                <textarea class='form-control' style='height:100px' name='question[2]'>{{ $questions[2] ? $questions[2]->answer : '' }}</textarea>
                            ...
                            <div class='form-group'>
                                ...
                                <textarea class='form-control' style='height:100px' name='question[3]'>{{ $questions[3] ? $questions[3]->answer : '' }}</textarea>
                            </div>
                            <div class='form-group'>
                                <label class='control-label font-bold text-black'>
                                ...
                                <textarea class='form-control' style='height:100px' name='question[4]'>{{ $questions[4] ? $questions[4]->answer : '' }}</textarea>
                            </div>
                            <div class='form-group'>
                                <label class='control-label font-bold text-black'>
                                ...
                                <textarea class='form-control' style='height:100px' name='question[5]'>{{ $questions[5] ? $questions[5]->answer : '' }}</textarea>
                            </div>
                            <div class='form-group'>
                                <label class='control-label font-bold text-black'>
                                ...
                                <textarea class='form-control' style='height:100px' name='question[6]'>{{ $questions[6] ? $questions[6]->answer : '' }}</textarea>
                            </div>
                            <div class='form-group'>
                                <label class='control-label font-bold text-black'>
                                7. Any previous experience which aligns with your proposed project that you would like to share. (500 words) 
                                </label>
                                <textarea class='form-control' style='height:100px' name='question[7]'>{{ $questions[7] ? $questions[7]->answer : '' }}</textarea>
                            </div>
                            <div class='form-group'>
                                <label class='control-label font-bold text-black'>
                                ...
                                <input class='form-control' name='question[8]' value='{{ $questions[8] ? $questions[8]->answer : '' }}'>
                            </div>
                            <div class='form-group'>
                                <label class='control-label font-bold text-black'>
                                ...
                                <div class='row'>
                                    <div class='col-lg-4'>
                                        <input type='file' class='form-control' name='question[file][]'>
                                    </div>
                                    <div class='col-lg-4'>
                                        <input type='file' class='form-control' name='question[file][]'>
                                    </div>
                            ...
                            <div class='form-group'>
                                ...
                                <textarea class='form-control' style='height:100px' name='question[10]'>{{ $questions[10] ? $questions[10]->answer : '' }}</textarea>
                            </div>
                            <div class='form-group'>
                                <label class='control-label font-bold text-black'>
                                ...
                                <textarea class='form-control' style='height:100px' name='question[11]'>{{ $questions[11] ? $questions[11]->answer : ''}}</textarea>
                            </div>
                            <?php 
                                $answers =  $questions[12]->answer ? $questions[12]->answer : '000';
                                $answer1 = substr($answers,0,1);
                                $answer2 = substr($answers,1,1);
                                $answer3 = substr($answers,2,1);
                            ?>
                            <div class='form-group'>
                                <label class='control-label font-bold text-black'>
                                ...
                                <table class='table table-bordered table-striped'>
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td><input type='radio' class='form-control' name='question[12][radio1]' value='1' <?php if($answer1 == 1)echo 'checked'?>></td>
                                            <td><input type='radio' class='form-control'  name='question[12][radio1]' value='0' <?php if($answer1 == 0)echo 'checked'?>></td>
                                        </tr>
                                        <tr>
                                            <td>In case you do decide to set-up a venture post completion of your project based on your work during this period, would you be willing to provide Anusha Welfare Trust & partner companies equity investment in your new venture up toogu5% at the same terms as yourself? </td>
                                            <td><input type='radio' class='form-control' name='question[12][radio2]' value='1' <?php if($answer2 == 1)echo 'checked'?>></td>
                                            <td><input type='radio' class='form-control' name='question[12][radio2]' value='0' <?php if($answer2 == 0)echo 'checked'?>></td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td><input type='radio' class='form-control' name='question[12][radio3]' value='1' <?php if($answer3 == 1)echo 'checked'?>></td>
                                            <td><input type='radio' class='form-control' name='question[12][radio3]' value='0' <?php if($answer3 == 0)echo 'checked'?>></td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
                            ...
                            @else
                                <button class="btn btn-primary text-uppercase" disabled>Submit <i class='fa fa-check text-white'></i></button>
                            @endif
                            ...
                            <br>
                            <p>You cannot submit or save unless you register/ login</p>
                        </form>
                    </div>
