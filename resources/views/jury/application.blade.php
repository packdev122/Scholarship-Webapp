...
@section('main')    
    ...
    <div class="page-bar">
        <ul class="page-breadcrumb">
            <li>
                ...
                <a href="{{ url('/jury/applications') }}">Applications</a>
    ...
    <div class='main-content'>
        <div >
            <button class='btn btn-success pull-right'><i class='fa fa-list'></i> View Application</button>
            <h4>Total Score : <label id='total_score' class='font-bold font-size-20'>{{ $application->score }}</label></h4>
        </div><hr>
